...
import {CourseDescriptionPutPanel} from '../../custom/course/putPage/CourseDescription';
import {CourseNamePutPanel} from '../../custom/course/putPage/CourseName';
